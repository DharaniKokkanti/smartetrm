...
public class GlAccount {
    ...
    // Setter exists only so GlAccountService.update() can copy the existing
    // value forward on the response object (mirrors createdBy/createdAt
    // above) — the created_src_id column itself is
