...
/**
 * Resolves dbo.sys_source_system ids for JPA entity provenance stamping
 ...
 * hatch for exactly this problem. Resolved once — dbo.sys_source_system rows
...
public class SourceSystemDefaults {
    ...
    /** Returns {@code short} not {@code int} — dbo.sys_source_system.source_system_id
