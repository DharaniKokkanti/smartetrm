...
/** V102 added `role` — see that migration's doc comment. created_at/
 * created_by/updated_at/updated_by governance columns added by V149 (link
 * table only ever gets create()/delete(), never update() — see
