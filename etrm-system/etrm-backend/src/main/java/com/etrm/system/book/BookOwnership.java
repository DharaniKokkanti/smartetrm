 ...
 * free-text externalOwnerName fallback. Only created_at/created_by (no
 * updated columns) — same convention as BookClassification/BookTrader,
 * does not extend AuditableEntity.
 */
@Entity
