...
export const bookAccessGrantsSeed: BookAccessGrant[] = [
  ...
  { grantId: 2, userId: 3, userFullName: 'Alice Smith', username: 'a.smith', scopeType: 'DESK', scopeId: 2, scopeLabel: 'GAS-EU — European Gas', accessLevel: 'READ_WRITE', status: 'ACTIVE', assignedBy: 'admin', assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin', approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
