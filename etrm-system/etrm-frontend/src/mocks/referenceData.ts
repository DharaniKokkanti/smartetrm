...
export const rowSeed: Record<string, ReferenceDataRow[]> = {
  ...
  credit_term: [
    { creditTermId: 1,  termCode: 'NET_30',           termName: 'Net 30 Days',                creditPeriodDays: 30, collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 30 days from invoice.', isActive: true },
    ...
    { creditTermId: 5,  termCode: 'NET_7',            termName: 'Net 7 Days',                 creditPeriodDays: 7,  collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 7 days from invoice.', isActive: true },
    { creditTermId: 6,  termCode: 'NET_14',           termName: 'Net 14 Days',                creditPeriodDays: 14, collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 14 days from invoice.', isActive: true },
    { creditTermId: 7,  termCode: 'NET_45',           termName: 'Net 45 Days',                creditPeriodDays: 45, collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 45 days from invoice.', isActive: true },
    { creditTermId: 8,  termCode: 'NET_60',           termName: 'Net 60 Days',                creditPeriodDays: 60, collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 60 days from invoice.', isActive: true },
    { creditTermId: 9,  termCode: 'NET_90',           termName: 'Net 90 Days',                creditPeriodDays: 90, collateralType: 'NONE',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Open unsecured credit, due 90 days from invoice.', isActive: true },
    { creditTermId: 10, termCode: 'PREPAY',           termName: 'Prepaid — No Credit',        creditPeriodDays: 0,  collateralType: 'CASH',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Full payment required before delivery/execution — no open credit exposure.', isActive: true },
    { creditTermId: 11, termCode: 'CASH_ON_DELIVERY', termName: 'Cash on Delivery',           creditPeriodDays: 0,  collateralType: 'CASH',             marginCallThreshold: null,    marginCallCurrency: 'USD', nettingEligible: false, requiresIsda: false, description: 'Payment due concurrent with delivery — no open credit exposure.', isActive: true },
  ],
  holiday_calendar: [
