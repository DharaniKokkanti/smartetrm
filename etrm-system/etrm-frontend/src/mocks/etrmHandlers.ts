...
const booksStore: unknown[] = [
  ...
  { bookId: 2, bookCode: 'CRUDE-HEDGE',  bookName: 'Crude Hedge Book',     bookType: 'HEDGING',   deskId: 1, deskCode: 'OIL-CRUDE',   legalEntityId: 1, legalEntityCode: 'ACME-UK', responsibleTraderId: null, responsibleTraderName: null,               commodityType: 'OIL',         currencyCode: 'USD', positionLimit: 10000000, pnlLimit: null,    varLimit: 100000, goLiveDate: '2020-01-01', description: 'Hedge book for crude oil futures offsetting physical exposure.',          isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { bookId: 3, bookCode: 'GAS-EU-TRADE', bookName: 'EU Gas Trading',       bookType: 'TRADING',   deskId: 2, deskCode: 'GAS-EU',      legalEntityId: 2, legalEntityCode: 'ACME-US',  responsibleTraderId: 2,    responsibleTraderName: 'Alice Smith',       commodityType: 'GAS',         currencyCode: 'EUR', positionLimit: 2000000,  pnlLimit: 200000,  varLimit: 50000,  goLiveDate: '2020-01-01', description: 'European natural gas physical and financial book — TTF and NBP.',         isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { bookId: 4, bookCode: 'LME-CU-ARB',  bookName: 'Copper Arbitrage',     bookType: 'ARBITRAGE', deskId: 3, deskCode: 'METALS-BASE', legalEntityId: 1, legalEntityCode: 'ACME-UK', responsibleTraderId: 3,    responsibleTraderName: 'Raj Kumar Patel',  commodityType: 'METALS',      currencyCode: 'USD', positionLimit: 1000,     pnlLimit: 100000,  varLimit: 25000,  goLiveDate: '2022-01-10', description: 'LME copper cash/3M arbitrage and spread trading book.',                 isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { bookId: 5, bookCode: 'POWER-CLIENT', bookName: 'Power Client Book',    bookType: 'CLIENT',    deskId: 4, deskCode: 'POWER-EU',    legalEntityId: 2, legalEntityCode: 'ACME-US',  responsibleTraderId: 6,    responsibleTraderName: 'Sarah Wong',        commodityType: 'POWER',       currencyCode: 'EUR', positionLimit: 500000,   pnlLimit: null,    varLimit: null,   goLiveDate: '2024-02-01', description: 'European power client back-to-back book — EEX German and French baseload.', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
...
const tradersStore: unknown[] = [
  ...
  { traderId: 2, traderCode: 'ASM', fullName: 'Alice Smith',     email: 'alice.smith@smartetrm.com',    userId: 102, legalEntityId: 2, legalEntityCode: 'ACME-US',  deskId: 2, deskCode: 'GAS-EU',      deskName: 'European Gas',       commodityTypes: ['GAS', 'POWER'], commodityLimits: [{ commodityType: 'GAS',   singleTradeLimit: 10000000, dailyTradeLimit: 40000000,  positionLimit: 100000000 }, { commodityType: 'POWER',  singleTradeLimit: 5000000,  dailyTradeLimit: 20000000, positionLimit: 50000000 }], approverTraderId: null, approverName: null,          goLiveDate: '2019-06-15', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  ...
  { traderId: 5, traderCode: 'PLN', fullName: 'Pierre Lefebvre', email: 'pierre.lefebvre@smartetrm.com', userId: 105, legalEntityId: 2, legalEntityCode: 'ACME-US', deskId: 2, deskCode: 'GAS-EU',      deskName: 'European Gas',       commodityTypes: ['GAS', 'LNG'], commodityLimits: [{ commodityType: 'GAS',   singleTradeLimit: 8000000,  dailyTradeLimit: 30000000,  positionLimit: 80000000 }],                                                                                                                                        approverTraderId: 2,    approverName: 'Alice Smith', goLiveDate: '2021-04-01', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { traderId: 6, traderCode: 'SWN', fullName: 'Sarah Wong',      email: 'sarah.wong@smartetrm.com',    userId: 106, legalEntityId: 2, legalEntityCode: 'ACME-US',  deskId: 4, deskCode: 'POWER-EU',    deskName: 'European Power',     commodityTypes: ['POWER'],      commodityLimits: [{ commodityType: 'POWER',  singleTradeLimit: 3000000,  dailyTradeLimit: 15000000,  positionLimit: 30000000 }],                                                                                                                                        approverTraderId: 2,    approverName: 'Alice Smith', goLiveDate: '2024-02-01', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
