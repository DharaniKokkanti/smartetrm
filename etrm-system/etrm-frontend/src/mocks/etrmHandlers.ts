...
export const etrmHandlers = [
  ...
  http.post(`${API}/trades`, async ({ request }) => {
    ...
    const row = {
      ...
      sourceChannelCode: 'MANUAL', // only capture path today — the Trade Blotter monitoring page is where feed/upload/API rows would land
      amendmentNumber: 0,
