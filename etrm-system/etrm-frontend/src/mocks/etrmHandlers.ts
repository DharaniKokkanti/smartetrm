...
export const etrmHandlers = [
  ...
  http.post(`${API}/trades`, async ({ request }) => {
    ...
    const row = {
      ...
      createdSourceSystemId: 1, createdSourceSystemCode: 'TRADE_CAPTURE_SCREEN', updatedSourceSystemId: 1, updatedSourceSystemCode: 'TRADE_CAPTURE_SCREEN', // only capture path today — the Trade Blotter monitoring page is where feed/upload/API rows would land
      amendmentNumber: 0,
