...
const tradesStore: unknown[] = [
  ...
  { tradeId: 2,  tradeReference: 'TRD-2026-00002', contractNumber: null,                      tradeDate: '2026-06-03', executionDatetime: '2026-06-03T10:15:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'SELL', termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 2, counterpartyName: 'BP Oil Trading',            traderId: 4, traderCode: 'MJL', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 8310000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00002', paymentCalendarCode: 'UK_BANK', contractPeriodicity: 'MONTHLY', contractStatus: 'ACTIVE', specialReference: null, notes: 'Hedge against physical inventory',     parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'SWAP_FIXED_FLOAT', createdAt: '2026-06-03T10:15:00Z', updatedAt: '2026-06-03T10:15:00Z' },
  { tradeId: 3,  tradeReference: 'TRD-2026-00003', contractNumber: 'EQ-TTF-2026-M07-M08',    tradeDate: '2026-06-05', executionDatetime: '2026-06-05T08:45:00Z', commodityType: 'GAS',          tradeType: 1,  direction: 'BUY',  termType: 'RFP',  dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 3, counterpartyName: 'Equinor Energy AS',         traderId: 2, traderCode: 'ASM', rfpMinQty: 40000, rfpMaxQty: 60000, rfpStartDate: '2026-07-01', rfpEndDate: '2026-08-31', rfpFrequency: 'MONTHLY', creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 1727500, gtcReference: 'EFET-GAS-2002', hedgeFlag: false, cin: 'CIN-2026-00003', paymentCalendarCode: 'ECB_TARGET', contractPeriodicity: 'MONTHLY', contractStatus: 'ACTIVE', specialReference: null, notes: 'TTF Jul-Aug monthly contract',         parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 2, instrumentType: 'PHYSICAL', createdAt: '2026-06-05T08:45:00Z', updatedAt: '2026-06-05T08:45:00Z' },
  ...
  { tradeId: 10, tradeReference: 'TRD-2026-00010', contractNumber: 'CME-TAS-WTI-2026-001',   tradeDate: '2026-06-28', executionDatetime: '2026-06-28T14:05:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 3, counterpartyName: 'Trafigura Group',            traderId: 1, traderCode: 'JDO', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 7245000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00010', paymentCalendarCode: 'US_FEDERAL',  contractPeriodicity: 'MONTHLY', contractStatus: 'ACTIVE', specialReference: null, notes: 'WTI CL TAS +2 ticks for Dec/Jan strip',       parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 2, instrumentType: 'FUTURES', createdAt: '2026-06-28T14:05:00Z', updatedAt: '2026-06-28T14:05:00Z' },
  // TRD-011: GAS FINANCIAL SELL — NG TAS (1 leg — NGF27 locked)
  { tradeId: 11, tradeReference: 'TRD-2026-00011', contractNumber: 'CME-TAS-NG-2026-001',    tradeDate: '2026-06-27', executionDatetime: '2026-06-27T13:55:00Z', commodityType: 'GAS',          tradeType: 2, direction: 'SELL', termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 5, counterpartyName: 'ExxonMobil Global Trading',  traderId: 4, traderCode: 'MJL', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 345500,   gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00011', paymentCalendarCode: 'US_FEDERAL',  contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'NG TAS -1 tick Jan 27 — price locked',        parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-06-27T13:55:00Z', updatedAt: '2026-06-27T13:55:00Z' },
  // TRD-012: OIL FINANCIAL BUY — WTI BALMO Jul 2026 (booked mid-month, prices from Jul 14)
  { tradeId: 12, tradeReference: 'TRD-2026-00012', contractNumber: 'CME-BALMO-WTI-2026-001', tradeDate: '2026-07-01', executionDatetime: '2026-07-01T10:30:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 2, counterpartyName: 'BP Energy Europe',           traderId: 1, traderCode: 'JDO', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 7200000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00012', paymentCalendarCode: 'US_FEDERAL',  contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'WTI BALMO Jul26 — booked Jul 1, prices from Jul 1 to Jul 31', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-07-01T10:30:00Z', updatedAt: '2026-07-01T10:30:00Z' },
  // TRD-013: OIL FINANCIAL SELL — ICE Brent BALMO Jul 2026
  { tradeId: 13, tradeReference: 'TRD-2026-00013', contractNumber: 'ICE-BALMO-BZ-2026-001',  tradeDate: '2026-07-01', executionDatetime: '2026-07-01T14:10:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'SELL', termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 6, counterpartyName: 'Glencore Energy UK',         traderId: 1, traderCode: 'JDO', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 5000000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00013', paymentCalendarCode: 'UK_BANK', contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'Brent BALMO Jul26 — sell side hedge', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-07-01T14:10:00Z', updatedAt: '2026-07-01T14:10:00Z' },
  // RINS — D6 conventional ethanol RINs, separated, spot certificate transfer via EPA EMTS
  { tradeId: 14, tradeReference: 'TRD-2026-00014', contractNumber: 'EMTS-2026-D6-0455',      tradeDate: '2026-07-02', executionDatetime: '2026-07-02T15:20:00Z', commodityType: 'RINS',         tradeType: 1,  direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'SPOT',    status: 'CONFIRMED', counterpartyId: 8, counterpartyName: 'Cargill International SA',  traderId: 2, traderCode: 'ASM', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_14', creditApprovalStatus: 'APPROVED', creditLimitUsed: 4250000,  gtcReference: 'RFS2-MSA-2024',     hedgeFlag: false, cin: 'CIN-2026-00014', paymentCalendarCode: 'US_FEDERAL',  contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'D6 2026 vintage separated RINs for RVO compliance', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'CERTIFICATE_TRANSFER', createdAt: '2026-07-02T15:20:00Z', updatedAt: '2026-07-02T15:20:00Z' },
  // ENVIRONMENTAL — EUA Dec-26 futures on ICE, physical delivery of allowances at expiry
  { tradeId: 15, tradeReference: 'TRD-2026-00015', contractNumber: 'ICE-EUA-Z26-7731',        tradeDate: '2026-07-02', executionDatetime: '2026-07-02T09:45:00Z', commodityType: 'ENVIRONMENTAL', tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 5, counterpartyName: 'RWE Supply & Trading',      traderId: 6, traderCode: 'SWN', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 3625000,  gtcReference: 'ICE-ENDEX-RULES',   hedgeFlag: true,  cin: 'CIN-2026-00015', paymentCalendarCode: 'ECB_TARGET', contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'EUA Dec26 futures — hedge for power book carbon exposure', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-07-02T09:45:00Z', updatedAt: '2026-07-02T09:45:00Z' },
];
