...
const booksStore: unknown[] = [
  ...
  { bookId: 5, bookCode: 'POWER-CLIENT', bookName: 'Power Client Book',    bookType: 'CLIENT',    deskId: 4, deskCode: 'POWER-EU',    legalEntityId: 2, legalEntityCode: 'ACME-US',  responsibleTraderId: 6,    responsibleTraderName: 'Sarah Wong',        commodityType: 3,             baseCurrencyId: 2, positionLimit: 500000,   pnlLimit: null,    varLimit: null,   goLiveDate: '2024-02-01', description: 'European power client back-to-back book — EEX German and French baseload.', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
...
const holidayCalendarsStore: unknown[] = [
  { calendarId: 1, calendarCode: 'UK_BANK', calendarName: 'UK Bank Holidays', calendarType: 'BANKING', countryId: 1, currencyCode: 'GBP', description: 'UK public holidays and Bank Holidays as observed by the London interbank market', isActive: true, holidayCount: 82, createdAt: '2024-01-01T00:00:00Z' },
  { calendarId: 2, calendarCode: 'US_FEDERAL', calendarName: 'US Federal Holidays', calendarType: 'BANKING', countryId: 2, currencyCode: 'USD', description: 'US Federal Reserve banking holidays — SIFMA calendar basis', isActive: true, holidayCount: 80, createdAt: '2024-01-01T00:00:00Z' },
  { calendarId: 3, calendarCode: 'NYMEX_WTI', calendarName: 'NYMEX WTI Futures Calendar', calendarType: 'EXCHANGE', countryId: 2, currencyCode: 'USD', description: 'CME/NYMEX exchange trading holidays', isActive: true, holidayCount: 65, createdAt: '2024-01-01T00:00:00Z' },
  { calendarId: 4, calendarCode: 'LME_METALS', calendarName: 'LME Metals Calendar', calendarType: 'COMMODITY', countryId: 1, currencyCode: 'USD', description: 'LME ring trading holidays and closure dates', isActive: true, holidayCount: 70, createdAt: '2024-01-01T00:00:00Z' },
  { calendarId: 5, calendarCode: 'ECB_TARGET', calendarName: 'ECB TARGET2 Payment System Holidays', calendarType: 'BANKING', countryId: null, currencyCode: 'EUR', description: 'European Central Bank TARGET2 payment system holidays — applies to EUR settlements', isActive: true, holidayCount: 58, createdAt: '2024-01-01T00:00:00Z' },
  { calendarId: 6, calendarCode: 'ICE_BRENT', calendarName: 'ICE Brent Futures Calendar', calendarType: 'EXCHANGE', countryId: 1, currencyCode: 'USD', description: 'ICE Futures Europe exchange holidays — Brent, Gasoil, TTF', isActive: true, holidayCount: 66, createdAt: '2024-01-01T00:00:00Z' },
];
