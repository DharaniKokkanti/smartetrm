...
const tradesStore: unknown[] = [
  ...
  { tradeId: 2,  tradeReference: 'TRD-2026-00002', contractNumber: null,                      tradeDate: '2026-06-03', executionDatetime: '2026-06-03T10:15:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'SELL', termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 2, counterpartyName: 'BP Oil Trading',            traderId: 4, traderCode: 'MJL', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 8310000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00002', paymentCalendarCode: 'LON-USD', contractPeriodicity: 'MONTHLY', contractStatus: 'ACTIVE', specialReference: null, notes: 'Hedge against physical inventory',     parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'SWAP_FIXED_FLOAT', createdAt: '2026-06-03T10:15:00Z', updatedAt: '2026-06-03T10:15:00Z' },
  ...
  { tradeId: 10, tradeReference: 'TRD-2026-00010', contractNumber: 'CME-TAS-WTI-2026-001',   tradeDate: '2026-06-28', executionDatetime: '2026-06-28T14:05:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 3, counterpartyName: 'Trafigura Group',            traderId: 1, traderCode: 'JDO', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 7245000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00010', paymentCalendarCode: 'NY-USD',  contractPeriodicity: 'MONTHLY', contractStatus: 'ACTIVE', specialReference: null, notes: 'WTI CL TAS +2 ticks for Dec/Jan strip',       parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 2, instrumentType: 'FUTURES', createdAt: '2026-06-28T14:05:00Z', updatedAt: '2026-06-28T14:05:00Z' },
  // TRD-011: GAS FINANCIAL SELL — NG TAS (1 leg — NGF27 locked)
  { tradeId: 11, tradeReference: 'TRD-2026-00011', contractNumber: 'CME-TAS-NG-2026-001',    tradeDate: '2026-06-27', executionDatetime: '2026-06-27T13:55:00Z', commodityType: 'GAS',          tradeType: 2, direction: 'SELL', termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 5, counterpartyName: 'ExxonMobil Global Trading',  traderId: 4, traderCode: 'MJL', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 345500,   gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00011', paymentCalendarCode: 'NY-USD',  contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'NG TAS -1 tick Jan 27 — price locked',        parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-06-27T13:55:00Z', updatedAt: '2026-06-27T13:55:00Z' },
  // TRD-012: OIL FINANCIAL BUY — WTI BALMO Jul 2026 (booked mid-month, prices from Jul 14)
  { tradeId: 12, tradeReference: 'TRD-2026-00012', contractNumber: 'CME-BALMO-WTI-2026-001', tradeDate: '2026-07-01', executionDatetime: '2026-07-01T10:30:00Z', commodityType: 'OIL',          tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 2, counterpartyName: 'BP Energy Europe',           traderId: 1, traderCode: 'JDO', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 7200000,  gtcReference: 'ISDA-2002',         hedgeFlag: true,  cin: 'CIN-2026-00012', paymentCalendarCode: 'NY-USD',  contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'WTI BALMO Jul26 — booked Jul 1, prices from Jul 1 to Jul 31', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-07-01T10:30:00Z', updatedAt: '2026-07-01T10:30:00Z' },
  ...
  { tradeId: 15, tradeReference: 'TRD-2026-00015', contractNumber: 'ICE-EUA-Z26-7731',        tradeDate: '2026-07-02', executionDatetime: '2026-07-02T09:45:00Z', commodityType: 'ENVIRONMENTAL', tradeType: 2, direction: 'BUY',  termType: 'SPOT', dealIndicator: 'EXTERNAL', contractType: 'MONTHLY', status: 'CONFIRMED', counterpartyId: 5, counterpartyName: 'RWE Supply & Trading',      traderId: 6, traderCode: 'SWN', rfpMinQty: null, rfpMaxQty: null, rfpStartDate: null, rfpEndDate: null, rfpFrequency: null, creditTermCode: 'NET_30', creditApprovalStatus: 'APPROVED', creditLimitUsed: 3625000,  gtcReference: 'ICE-ENDEX-RULES',   hedgeFlag: true,  cin: 'CIN-2026-00015', paymentCalendarCode: 'FRA-EUR', contractPeriodicity: null,      contractStatus: 'ACTIVE', specialReference: null, notes: 'EUA Dec26 futures — hedge for power book carbon exposure', parentTradeId: null, amendmentNumber: 0, isLatestVersion: true, orderCount: 1, instrumentType: 'FUTURES', createdAt: '2026-07-02T09:45:00Z', updatedAt: '2026-07-02T09:45:00Z' },
];
