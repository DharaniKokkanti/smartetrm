...
const tradersStore: unknown[] = [
  ...
  { traderId: 2, traderCode: 'ASM', fullName: 'Alice Smith',     email: 'alice.smith@smartetrm.com',    userId: 3, legalEntityId: 2, legalEntityCode: 'ACME-US',  deskId: 2, deskCode: 'GAS-EU',      deskName: 'European Gas',       commodityTypes: [2, 3], commodityLimits: [{ commodityType: 2, singleTradeLimit: 10000000, dailyTradeLimit: 40000000,  positionLimit: 100000000 }, { commodityType: 3, singleTradeLimit: 5000000,  dailyTradeLimit: 20000000, positionLimit: 50000000 }], approverTraderId: null, approverName: null,          goLiveDate: '2019-06-15', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  ...
  { traderId: 4, traderCode: 'MJL', fullName: 'Maria Jensen',    email: 'maria.jensen@smartetrm.com',  userId: 11, legalEntityId: 1, legalEntityCode: 'ACME-UK', deskId: 1, deskCode: 'OIL-CRUDE',   deskName: 'Crude Oil Trading',  commodityTypes: [1],    commodityLimits: [{ commodityType: 1, singleTradeLimit: 12500000, dailyTradeLimit: 50000000,  positionLimit: 100000000 }],                                                                                                             approverTraderId: 1,    approverName: 'John Doe',    goLiveDate: '2023-09-01', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { traderId: 5, traderCode: 'PLN', fullName: 'Pierre Lefebvre', email: 'pierre.lefebvre@smartetrm.com', userId: 12, legalEntityId: 2, legalEntityCode: 'ACME-US', deskId: 2, deskCode: 'GAS-EU',      deskName: 'European Gas',       commodityTypes: [2, 4], commodityLimits: [{ commodityType: 2, singleTradeLimit: 8000000,  dailyTradeLimit: 30000000,  positionLimit: 80000000 }],                                                                                                              approverTraderId: 2,    approverName: 'Alice Smith', goLiveDate: '2021-04-01', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { traderId: 6, traderCode: 'SWN', fullName: 'Sarah Wong',      email: 'sarah.wong@smartetrm.com',    userId: 13, legalEntityId: 2, legalEntityCode: 'ACME-US',  deskId: 4, deskCode: 'POWER-EU',    deskName: 'European Power',     commodityTypes: [3],    commodityLimits: [{ commodityType: 3, singleTradeLimit: 3000000,  dailyTradeLimit: 15000000,  positionLimit: 30000000 }],                                                                                                              approverTraderId: 2,    approverName: 'Alice Smith', goLiveDate: '2024-02-01', isActive: true, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
...
export const systemUsersStore: unknown[] = [
  ...
  { userId: 10, username: 'r.patel', email: 'raj.patel@smartetrm.com', fullName: 'Raj Kumar Patel', traderId: 3, department: 'Base Metals', phone: '+44 20 7123 0010', preferredLocale: 'en-GB', officeLocation: 'London', isActive: true, lastLogin: '2026-06-27T08:10:00Z', createdAt: '2024-01-01T00:00:00Z' },
  { userId: 11, username: 'm.jensen', email: 'maria.jensen@smartetrm.com', fullName: 'Maria Jensen', traderId: 4, department: 'Crude Oil Trading', phone: '+44 20 7123 0011', preferredLocale: 'en-GB', officeLocation: 'London', isActive: true, lastLogin: '2026-06-27T08:20:00Z', createdAt: '2024-01-01T00:00:00Z' },
  { userId: 12, username: 'p.lefebvre', email: 'pierre.lefebvre@smartetrm.com', fullName: 'Pierre Lefebvre', traderId: 5, department: 'European Gas', phone: '+33 1 4123 0012', preferredLocale: 'fr-FR', officeLocation: 'Paris', isActive: true, lastLogin: '2026-06-26T18:00:00Z', createdAt: '2024-01-01T00:00:00Z' },
  { userId: 13, username: 's.wong', email: 'sarah.wong@smartetrm.com', fullName: 'Sarah Wong', traderId: 6, department: 'European Power', phone: '+65 6123 0013', preferredLocale: 'en-SG', officeLocation: 'Singapore', isActive: true, lastLogin: '2026-06-27T09:00:00Z', createdAt: '2024-01-01T00:00:00Z' },
];
...
const gtcsStore: unknown[] = [
  { gtcId: 1, gtcCode: 'BP-OIL-2020', gtcName: 'BP Standard Crude Oil GTCs 2020', gtcType: 'CRUDE_OIL', version: '2020-v3', effectiveDate: '2020-01-01', expiryDate: null, jurisdictionId: 1, governingLaw: 'English Law', disputeResolution: 'LCIA', documentRef: 'DOC-GTC-001', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
  { gtcId: 2, gtcCode: 'EFET-GAS-2019', gtcName: 'EFET General Agreement Gas 2019', gtcType: 'GAS', version: '2019-v2', effectiveDate: '2019-07-01', expiryDate: null, jurisdictionId: 1, governingLaw: 'English Law', disputeResolution: 'ICC', documentRef: 'DOC-GTC-002', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
  { gtcId: 3, gtcCode: 'LME-METALS-2021', gtcName: 'LME Contract Rules & Regulations 2021', gtcType: 'METALS', version: '2021-v1', effectiveDate: '2021-01-01', expiryDate: null, jurisdictionId: 1, governingLaw: 'English Law', disputeResolution: 'Court', documentRef: 'DOC-GTC-003', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
  { gtcId: 4, gtcCode: 'GAFTA-100', gtcName: 'GAFTA Contract No.100 (Grains CIF)', gtcType: 'AGRICULTURAL', version: 'Rev 2024', effectiveDate: '2024-01-01', expiryDate: null, jurisdictionId: 1, governingLaw: 'English Law', disputeResolution: 'GAFTA Arbitration', documentRef: 'DOC-GTC-004', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
  { gtcId: 5, gtcCode: 'ISDA-2002-MA', gtcName: 'ISDA 2002 Master Agreement (Derivatives)', gtcType: 'GENERIC', version: '2002', effectiveDate: '2002-01-01', expiryDate: null, jurisdictionId: 2, governingLaw: 'New York Law', disputeResolution: 'Court (SDNY)', documentRef: 'DOC-GTC-005', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
  { gtcId: 6, gtcCode: 'NAESB-GAS-2013', gtcName: 'NAESB Base Contract for Sale of Natural Gas', gtcType: 'GAS', version: '2013', effectiveDate: '2013-01-01', expiryDate: null, jurisdictionId: 2, governingLaw: 'Texas Law', disputeResolution: 'AAA', documentRef: 'DOC-GTC-006', isActive: true, createdAt: '2024-01-01T00:00:00Z' },
];
