...
export const rolesSeed: UserRole[] = [
  { rowVersion: 0, roleId: 1, roleCode: 'ADMIN',          roleName: 'System Administrator', description: 'Full access to all modules including administration', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: adminGrants },
  { rowVersion: 0, roleId: 2, roleCode: 'TRADER',         roleName: 'Trader',               description: 'Create and manage trades; view counterparties and master data', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: traderGrants },
  { rowVersion: 0, roleId: 3, roleCode: 'RISK_MANAGER',   roleName: 'Risk Manager',         description: 'View and approve trades; view positions and P&L', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: riskGrants },
  { rowVersion: 0, roleId: 4, roleCode: 'OPERATIONS',     roleName: 'Operations',           description: 'Full counterparty and master data management; view trades', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: opsGrants },
  { rowVersion: 0, roleId: 5, roleCode: 'COMPLIANCE',     roleName: 'Compliance',           description: 'View and manage KYC/counterparty data; view trades', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: complianceGrants },
  { rowVersion: 0, roleId: 6, roleCode: 'VIEWER',         roleName: 'Read-Only Viewer',     description: 'Read-only access to all non-admin modules', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-01-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', functions: viewerGrants },
  // One custom role in PENDING_APPROVAL state
  { rowVersion: 0, roleId: 7, roleCode: 'CRUDE_TRADER',   roleName: 'Crude Oil Trader',     description: 'Crude-specific role with full trade access and read-only positions', roleType: 'CUSTOM', status: 'PENDING_APPROVAL', rejectionReason: null, isActive: true, createdBy: 'john.doe', createdAt: '2026-06-20T09:00:00Z', submittedAt: '2026-06-20T09:05:00Z', approvedBy: null, approvedAt: null, functions: [] },
  { rowVersion: 0, roleId: 8, roleCode: 'CREDIT_ANALYST', roleName: 'Credit Analyst',       description: 'Read-only counterparty, credit exposure, and position visibility for risk monitoring', roleType: 'SYSTEM', status: 'APPROVED', rejectionReason: null, isActive: true, createdBy: 'SYSTEM', createdAt: '2026-06-01T00:00:00Z', submittedAt: null, approvedBy: 'SYSTEM', approvedAt: '2026-06-01T00:00:00Z', functions: creditAnalystGrants },
];
...
// username/fullName mirror mocks/etrmHandlers.ts's systemUsersStore rows for
// the same userId — kept in sync by hand here (same denormalize-at-write
// choice already made for roleName/roleCode below); rbacHandlers.ts's POST
// handler does the equivalent live lookup for assignments created at runtime.
export const assignmentsSeed: UserRoleAssignment[] = [
  { assignmentId: 1, userId: 1, username: 'admin',      fullName: 'System Administrator', roleId: 1, roleName: 'System Administrator', roleCode: 'ADMIN',          status: 'ACTIVE', assignedBy: 'SYSTEM', assignedAt: '2026-01-01T00:00:00Z', approvedBy: 'SYSTEM', approvedAt: '2026-01-01T00:00:00Z', rejectionReason: null, validFrom: '2026-01-01', validTo: null, isActive: true },
  { assignmentId: 2, userId: 2, username: 'j.doe',      fullName: 'John Doe',              roleId: 2, roleName: 'Trader',               roleCode: 'TRADER',         status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin',  approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
  { assignmentId: 3, userId: 3, username: 'a.smith',    fullName: 'Alice Smith',           roleId: 2, roleName: 'Trader',               roleCode: 'TRADER',         status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin',  approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
  { assignmentId: 4, userId: 4, username: 'risk.mgr',   fullName: 'Risk Manager',          roleId: 3, roleName: 'Risk Manager',         roleCode: 'RISK_MANAGER',   status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin',  approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
  { assignmentId: 5, userId: 5, username: 'compliance', fullName: 'Compliance Officer',    roleId: 5, roleName: 'Compliance',           roleCode: 'COMPLIANCE',     status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin',  approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
  // Pending approval — kept as the one worked example of the request/approve workflow
  { assignmentId: 6, userId: 6, username: 'ops.team',   fullName: 'Operations Team',       roleId: 4, roleName: 'Operations',           roleCode: 'OPERATIONS',     status: 'PENDING_APPROVAL', assignedBy: 'admin', assignedAt: '2026-06-25T09:00:00Z', approvedBy: null, approvedAt: null, rejectionReason: null, validFrom: '2026-06-25', validTo: null, isActive: true },
  { assignmentId: 7, userId: 7, username: 'viewer1',    fullName: 'Board Viewer',          roleId: 6, roleName: 'Read-Only Viewer',     roleCode: 'VIEWER',         status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-01-15T10:00:00Z', approvedBy: 'admin',  approvedAt: '2026-01-15T10:30:00Z', rejectionReason: null, validFrom: '2026-01-15', validTo: null, isActive: true },
  { assignmentId: 8, userId: 8, username: 's.chen',     fullName: 'Sarah Chen',            roleId: 8, roleName: 'Credit Analyst',       roleCode: 'CREDIT_ANALYST', status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-06-01T00:00:00Z', approvedBy: 'admin',  approvedAt: '2026-06-01T00:30:00Z', rejectionReason: null, validFrom: '2026-06-01', validTo: null, isActive: true },
  { assignmentId: 9, userId: 9, username: 'm.webb',     fullName: 'Marcus Webb',           roleId: 8, roleName: 'Credit Analyst',       roleCode: 'CREDIT_ANALYST', status: 'ACTIVE', assignedBy: 'admin',  assignedAt: '2026-06-01T00:00:00Z', approvedBy: 'admin',  approvedAt: '2026-06-01T00:30:00Z', rejectionReason: null, validFrom: '2026-06-01', validTo: null, isActive: true },
];
