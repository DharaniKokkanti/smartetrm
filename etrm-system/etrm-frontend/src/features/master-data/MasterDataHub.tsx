...
const ALL_ENTRIES: Entry[] = [
  ...
  { live: true,  db: 'external_system_type', group: 'Organization & Users', label: 'External System Types', path: '/static-data/external_system_type', description: 'Integration categories — Market Data, ERP, CTRM, Shipping, Bank, Regulatory, Risk, AIS Tracking, Other. Parent table for external_system.external_system_type_id FK.', tags: ['external system type', 'integration', 'category'] },
