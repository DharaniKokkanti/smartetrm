...
const ALL_ENTRIES: Entry[] = [
  ...
  { live: true,  db: 'lookup_value',             group: 'Products & Markets', label: 'Lookup Values',              path: '/static-data/lookup_value',             description: 'Generic category/code/display-name reference table — add rows under a new category value to introduce a new axis without a dedicated table.', tags: ['lookup', 'category', 'generic', 'reference'] },
