...
const ALL_ENTRIES: Entry[] = [
  ...
  // ── Freight & Shipping ────────────────────────────────────────
  { live: true,  db: 'charter_party_type',     group: 'Freight & Shipping', label: 'Charter Party Types',    path: '/static-data/charter_party_type',       description: 'Voyage, time charter, and bareboat charter types — rate basis (WS flat, LSUM, PDAY), duration basis. Parent table for charter_party FK.', tags: ['charter', 'voyage', 'time charter', 'bareboat', 'worldscale', 'lsum'] },
  ...
  { live: false, db: 'uom_conversion',   group: 'Finance & Settlement', label: 'UoM Conversions',  path: '/reference/uom-conversions', description: 'Conversion factors between units — BBL to MT per crude grade, MMBTU to MWH, MT to m3 for LNG.', tags: ['conversion', 'bbl', 'mt', 'mmbtu', 'mwh', 'm3', 'lng', 'factor'] },

  // ── Risk & Compliance ─────────────────────────────────────────
  { live: true,  db: '— (iso 3166)',           group: 'Risk & Compliance', label: 'Countries',               path: '/reference/countries',      description: 'ISO 3166 country codes with FATF status and sanctions lists — OFAC SDN, EU Consolidated, UN — for KYC and sanctions screening.', tags: ['country', 'fatf', 'sanctions', 'ofac', 'eu', 'un', 'kyc', 'iso3166', 'jurisdiction'] },
