...
const ALL_ENTRIES: Entry[] = [
  ...
  { live: false, db: 'fx_rate',             group: 'Pricing & Rates', label: 'FX Rates',               path: '/pricing/fx-rates',             description: 'Historical and live FX rates per currency pair, now with a full forward curve — spot, standard tenors, and individual daily-forward delivery days via fx_period. Used for P&L revaluation and cross-currency settlement.', tags: ['fx', 'exchange rate', 'usd', 'eur', 'gbp', 'jpy', 'currency pair', 'revaluation', 'forward', 'curve', 'tenor'] },
