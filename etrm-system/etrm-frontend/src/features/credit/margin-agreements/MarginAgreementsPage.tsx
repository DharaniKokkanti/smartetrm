...
export function MarginAgreementsPage() {
  ...
  const { data: agreementTypeRows = [] }     = useTableRows<{ typeCode: string; typeName: string }>('ref_margin_agreement_type');
  const { data: valuationFreqRows = [] }     = useTableRows<{ typeCode: string; typeName: string }>('mst_valuation_frequency_type');
  const { data: governingLawRows = [] }      = useTableRows<{ typeCode: string; typeName: string }>('ref_governing_law_type');
