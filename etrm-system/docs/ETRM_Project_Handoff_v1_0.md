...
**Version:** 2.3 | **Date:** July 2026 | **Status:** Trade Capture + Credit & Risk Module Complete — migration frontier V63

---

## 0. Session Recap (read this first when resuming)

**Migration frontier: V63.** Next migration is **V64**. Every SQL change must be written to BOTH `etrm-system/database/NN_name.sql` (no V prefix) AND `etrm-backend/src/main/resources/db/migration/VNN__name.sql` (V prefix) — keep them byte-identical.
